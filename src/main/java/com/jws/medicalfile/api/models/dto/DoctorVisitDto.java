...
public class DoctorVisitDto {
    ...
    public DoctorVisitDto(Long id, PatientProfileDto patient, Date date,
                          DoctorInfoDto doctor, Date[] sickLeave, int sickLeaveDays,
                          String diagnosis, String treatment, DoctorVisitType visitType) {
        this.id = id;
